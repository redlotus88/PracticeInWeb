    ...
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
           ...
           <%--  <li>
            ...
            <li>
                <a href="#" data-selected-link="/skyeyes" aria-expanded="false"><i class="fa fa-eye"></i> 天眼监控<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="${ctx}/skyeyes/dashboard" data-selected-link="/skyeyes/dashboard"><i class="fa fa-dashboard"></i> 仪表盘</a>
                    </li>
                </ul>
            </li>
